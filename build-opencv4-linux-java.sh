#!/usr/bin/env bash
# ./build-opencv4-linux-java.sh "386"
# ./build-opencv4-linux-java.sh "amd64"
# ./build-opencv4-linux-java.sh "arm"
# ./build-opencv4-linux-java.sh "arm64"
# ./build-opencv4-linux-java.sh "ppc64le"
