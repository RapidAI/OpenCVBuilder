:: build opencv 3 for windows by benjaminwan
:: build-opencv3-win-java.bat x64 v142 md
:: build-opencv3-win-java.bat Win32 v142 md
:: build-opencv3-win-java.bat ARM64 v142 md
...
for /f "Delims=" %%x in (opencv3_cmake_options.txt) do set OPTIONS=!OPTIONS! %%x
